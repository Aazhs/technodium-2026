...
export default function Register({ user }: { user: any }) {
  ...
  return (
    <div className="page-wrap" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      {/* Decorative Shapes */}
      <div className="shape shape-1" style={{ top: '100px', left: '-120px', width: '300px', height: '300px', opacity: 0.3 }}></div>
      <div className="shape shape-3" style={{ top: '50%', right: '-80px', width: '250px', height: '250px', opacity: 0.3 }}></div>
