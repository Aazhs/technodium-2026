...
export default function Dashboard({ user }: { user: any }) {
  ...
  return (
    <div className="page-wrap" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      {/* Decorative Shapes */}
      <div className="shape shape-2" style={{ top: '150px', left: '-100px', width: '300px', height: '300px', opacity: 0.4 }}></div>
      <div className="shape shape-4" style={{ top: '40%', right: '-50px', width: '200px', height: '200px', opacity: 0.4 }}></div>
